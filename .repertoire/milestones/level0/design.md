...
## 🚨 CRITICAL FOUNDATION: sy-commons Architecture

**Core Rule**: "Common First" - Any functionality that can be shared across crates MUST be implemented in sy-commons first.

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                           SY-COMMONS FOUNDATION                             │
│                        (PREREQUISITE FOR ALL CRATES)                        │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────────────────┐ │
│  │  SymphonyError  │  │ Professional    │  │    Environment Config      │ │
│  │  (Base Error)   │  │   Logging       │  │   (TOML + Figment)         │ │
│  │                 │  │                 │  │                             │ │
│  │ • Validation    │  │ • tracing       │  │ • default.toml              │ │
│  │ • IO            │  │ • Console       │  │ • test.toml                 │ │
│  │ • Serialization │  │ • File          │  │ • production.toml           │ │
│  │ • Generic       │  │ • JSON          │  │ • Type-safe parsing         │ │
│  └─────────────────┘  └─────────────────┘  └─────────────────────────────┘ │
│                                                                             │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────────────────┐ │
│  │ Safe Filesystem │  │ Pre-validation  │  │     Duck Debugging          │ │
│  │   Utilities     │  │    Helpers      │  │                             │ │
│  │                 │  │                 │  │ • duck!() macro             │ │
│  │ • Professional  │  │ • Rule-based    │  │ • Temporary debugging       │ │
│  │   architecture  │  │   validation    │  │ • Searchable format         │ │
│  │ • Low complexity│  │ • NOT logging   │  │ • Development only          │ │
│  │ • Error handling│  │ • Fast checks   │  │                             │ │
│  └─────────────────┘  └─────────────────┘  └─────────────────────────────┘ │
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │                        lib.rs GUIDE                                │   │
...
│  │  • Re-exports: duck!(), SymphonyError, logging, config            │   │
│  │  • Usage examples for all public APIs                             │   │
│  │  • OCP compliance (Open for extension, Closed for modification)   │   │
│  │  • Co-located tests for every public function                     │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────────────────┘
```

**ALL Symphony crates MUST**:
