...
impl CorrelationManager {
    ...
    /// # }
    /// ```
    pub async fn register_request(&self, correlation_id: CorrelationId, reply_to: String) -> CorrelationResult<()> {
        ...
        duck!("Request created at: {}, timeout at: {}", pending_request.created_at, pending_request.timeout_at);
    ...
    /// # }
    /// ```
    pub async fn resolve_correlation(&self, correlation_id: CorrelationId) -> CorrelationResult<String> {
