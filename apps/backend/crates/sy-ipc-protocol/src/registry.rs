...
use crate::{
	...
	MessageEnvelope, MessageSerializer, MessageType, SchemaValidator, SerializationError,
	SerializationFormat,
};
...
impl MessageRegistry {
	...
	pub fn new() -> Self {
		...
		registry
			.register_message_type("extension_command".to_string(), MessageType::ExtensionCommand);
		registry.register_message_type(
			"conductor_decision".to_string(),
			MessageType::ConductorDecision,
		);
