...
impl From<PortError> for SymphonyError {
    fn from(err: PortError) -> Self {
        match err {
            ...
            PortError::AuthoritativeValidationError { message } => {
                SymphonyError::Validation {
