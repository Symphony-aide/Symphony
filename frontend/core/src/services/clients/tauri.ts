...
export class TauriClient extends Emittery<EventsInterface> implements Client {
	 ...
	 * @JsonRpcMethod
	 */
	public read_file_by_path(path: string, filesystemName: string): Promise<CoreResponse<FileInfo>> {
	 ...
	 * @JsonRpcMethod
	 */
	public write_file_by_path(path: string, content: string, filesystemName: string): Promise<CoreResponse<never>> {
	 ...
	 * @JsonRpcMethod
	 */
	public list_dir_by_path(path: string, filesystemName: string): Promise<CoreResponse<Array<DirItemInfo>>> {
	 ...
	 * @JsonRpcMethod
	 */
	public get_ext_info_by_id(extensionId: string): Promise<CoreResponse<ManifestInfo>> {
